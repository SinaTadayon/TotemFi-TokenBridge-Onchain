...
interface PeggedTotemTokenProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class PeggedTotemTokenProxy extends Contract {
  ...
  interface: PeggedTotemTokenProxyInterface;
  ...
  functions: {
    ...
    upgradeTo(
      _newPeggedTotemTokenImpl: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
