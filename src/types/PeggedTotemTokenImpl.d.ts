...
interface PeggedTotemTokenImplInterface extends ethers.utils.Interface {
  functions: {
...
export class PeggedTotemTokenImpl extends Contract {
  ...
  interface: PeggedTotemTokenImplInterface;
